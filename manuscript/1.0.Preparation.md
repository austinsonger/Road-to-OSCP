...
I> ```console
I> root@kali:/# chmod -v 764 new_file.txt 
I> mode of ‘new_file.txt’ changed from 0644 (rw-r–r–) to 0764 (rwxrw-r–)
I> ```
...
I> ```console
I> root@kali:/# chmod -v a+x new_file.txt 
I> mode of ‘new_file.txt’ changed from 0764 (rwxrw-r–) to 0775 (rwxrwxr-x)
I> ```
