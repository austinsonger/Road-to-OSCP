...
`root@linux:~# nmap 192.168.1.1`

##### Scan a host

`root@linux:~# nmap www.testhostname.com`

##### Scan a range of IPs

`root@linux:~# nmap 192.168.1.1-20`

##### Scan a subnet

`root@linux:~# nmap 192.168.1.0/24`

##### Scan targets from a text file

`root@linux:~# nmap -iL list-of-ips.txt`
...
`root@linux:~# nmap -p 22 192.168.1.1`

##### Scan a range of ports

`root@linux:~# nmap -p 1-100 192.168.1.1`

##### Scan 100 most common ports (Fast)   <-----------------FAST TEST

`root@linux:~# nmap -F 192.168.1.1`

##### Scan all 65535 ports  <-----------------ALL PORTS

`root@linux:~# nmap -p- 192.168.1.1`
...
`root@linux:~# nmap -sT 192.168.1.1`

##### Scan using TCP SYN scan (default)

`root@linux:~# nmap -sS 192.168.1.1`

##### Scan selected ports - ignore discovery

`root@linux:~# nmap -Pn -F 192.168.1.1`

##### Scan UDP ports 

`root@linux:~# nmap -sU -p 123,161,162 192.168.1.1`
...
`root@linux:~# nmap -A 192.168.1.1 <-----------------SYSTEM OPERACYJNY`

##### Standard service detection
`root@linux:~# nmap -sV 192.168.1.1 <-----------------SERVICE VERSION`

##### More aggressive Service Detection
`root@linux:~# nmap -sV --version-intensity 5 192.168.1.1`

##### Lighter banner grabbing detection 
`root@linux:~# nmap -sV --version-intensity 0 192.168.1.1`
